...
import {
    hourlyForecast as initialHourlyForecast,
    weeklyForecast as initialWeeklyForecast,
    currentWeather as initialCurrentWeather
...
export default function Forecast() {
    ...
    // Existing mock data is used initially as a fallback
    ...
    useEffect(() => {
        async function loadWeather() {
            try {
                ...
                setWeeklyForecast(weather.weeklyForecast);
            } catch (error) {
                console.error('Weather API error:', error);

                // If API fails, existing mock data remains visible
            }
        }
        ...
        <motion.div className="forecast-page" initial="initial" animate="animate">
            ...
            <motion.section className="forecast-hero" variants={fadeUp}>
                <div className="forecast-hero__left">
                    ...
                    <div className="forecast-hero__temp-row">
                        <span className="forecast-hero__temp">
                            {currentWeather.temperature}°
                        </span>

                        <div className="forecast-hero__condition">
                            <span className="forecast-hero__condition-name">
                                {currentWeather.condition}
                            </span>

                            <span className="forecast-hero__hl">
                                H:{weeklyForecast[0]?.high}°
                                {' '}
                                L:{weeklyForecast[0]?.low}°
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className="forecast-hero__sun">
                    <div className="forecast-hero__sun-item">
                        ...
                        <span className="forecast-hero__sun-label">
                            Sunrise
                        </span>

                        <span className="forecast-hero__sun-time">
                ...
                <div className="forecast-chart__header">
                    ...
                    <div className="forecast-chart__tabs">
                        {tabs.map(t => (
                            <button
                                key={t}
                                className={`forecast-chart__tab ${t === activeTab
                                    ? 'forecast-chart__tab--active'
                                    : ''
                                    }`}
                                onClick={() => setActiveTab(t)}
                            >
            ...
            {/* Precipitation Graph */}
            <motion.section
                className="forecast-chart-section"
                variants={fadeUp}
            >
                <h3 className="forecast-chart__title">
            ...
            >
                ...
                <div className="forecast-weekly__list">
                    {weeklyForecast.map((d, i) => (
                        ...
                        >
                            <div className="forecast-day__name">
                                <span className="forecast-day__day">
                                    {d.day}
                                </span>

                                <span className="forecast-day__date mono">
                                    {d.date}
                                </span>
                            </div>
